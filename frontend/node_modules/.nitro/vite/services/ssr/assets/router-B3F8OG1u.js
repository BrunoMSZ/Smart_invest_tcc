...
import { a as DialogTitle, i as DialogHeader, n as DialogContent, o as DialogTrigger, r as DialogDescription, t as Dialog } from "./dialog-DGl8EHd4.js";
...
import { n as getStoredToken, r as removeStoredToken, t as api } from "./api-QcSriJ06.js";
...
import { Activity, Bell, Building2, CheckCircle2, ChevronRight, Home, ImageUp, LineChart, Loader2, LogOut, MessageCircle, Newspaper, Pause, PieChart, Play, RefreshCw, ShieldCheck, Sparkles, TrendingDown, TrendingUp, Trophy, Upload, User, Users, Wallet, X } from "lucide-react";
...
//#endregion
//#region src/components/upload-proof-dialog.tsx
	...
	return /* @__PURE__ */ jsxs(Dialog, {
		...
		children: [/* @__PURE__ */ jsx(DialogTrigger, {
			...
			children: trigger ?? /* @__PURE__ */ jsxs(Button, {
				...
				children: [/* @__PURE__ */ jsx(Upload, { className: "h-4 w-4" }), "Enviar comprovante"]
			})
		}), /* @__PURE__ */ jsxs(DialogContent, {
			className: "max-w-md",
			children: [/* @__PURE__ */ jsxs(DialogHeader, { children: [/* @__PURE__ */ jsx(DialogTitle, { children: "Comprovante de aporte" }), /* @__PURE__ */ jsx(DialogDescription, { children: "Registre o aporte do mês no banco de dados e ganhe +1 ponto na sua liga." })] }), /* @__PURE__ */ jsxs("div", {
				className: "space-y-4",
				children: [
					/* @__PURE__ */ jsxs("label", {
						...
						children: [fileName ? /* @__PURE__ */ jsxs(Fragment, { children: [
							/* @__PURE__ */ jsx(CheckCircle2, { className: "h-7 w-7 text-success" }),
							/* @__PURE__ */ jsx("p", {
							...
							/* @__PURE__ */ jsx(ImageUp, { className: "h-7 w-7 text-primary" }),
							/* @__PURE__ */ jsx("p", {
								className: "text-sm font-medium",
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("div", {
							...
							className: "space-y-1.5",
							children: [/* @__PURE__ */ jsx(Label, { children: "Classe do ativo" }), /* @__PURE__ */ jsxs(Select, {
								value: classe,
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs(Button, {
							...
							disabled: loading,
							children: [/* @__PURE__ */ jsx(X, { className: "h-4 w-4" }), "Cancelar"]
						}), /* @__PURE__ */ jsx(Button, {
							className: "flex-1 font-semibold",
							onClick: handleEnviar,
							disabled: loading,
							children: loading ? /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(Loader2, { className: "h-4 w-4 animate-spin mr-2" }), "Salvando..."] }) : "Confirmar aporte"
						})]
					})
				]
			})]
...
function NavLink({ to, label, icon: Icon, active }) {
	return /* @__PURE__ */ jsxs(Link, {
		...
		children: [
			/* @__PURE__ */ jsx(Icon, { className: cn("h-4 w-4 shrink-0 transition-transform group-hover:scale-110", active ? "text-primary" : "text-muted-foreground") }),
			/* @__PURE__ */ jsx("span", {
				className: "truncate",
				children: label
			}),
			active && /* @__PURE__ */ jsx("span", { className: "ml-auto h-1.5 w-1.5 rounded-full bg-primary animate-pulse" })
		]
	});
}
function AppShell({ children }) {
	...
	const [editNome, setEditNome] = useState(currentUser.name);
	...
	const [tickerItems, setTickerItems] = useState(defaultMarketTickerItems);
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [
						/* @__PURE__ */ jsxs("div", {
							...
							children: [
								...
								/* @__PURE__ */ jsx("button", {
									...
									children: /* @__PURE__ */ jsx(RefreshCw, { className: cn("h-3 w-3", isRefreshingTicker && "animate-spin text-primary") })
								}),
								/* @__PURE__ */ jsx("button", {
									onClick: () => setIsTickerPaused((prev) => !prev),
									className: "p-1 text-muted-foreground hover:text-primary transition-colors rounded hover:bg-surface-2",
									title: isTickerPaused ? "Retomar rotação automática" : "Pausar rotação automática",
									children: isTickerPaused ? /* @__PURE__ */ jsx(Play, { className: "h-3 w-3 text-emerald-400" }) : /* @__PURE__ */ jsx(Pause, { className: "h-3 w-3" })
								})
							]
						}),
						/* @__PURE__ */ jsx("div", {
									...
									const content = /* @__PURE__ */ jsxs("div", {
										...
										children: [
											...
											/* @__PURE__ */ jsxs("span", {
												...
												children: [item.up ? /* @__PURE__ */ jsx(TrendingUp, { className: "h-2.5 w-2.5" }) : /* @__PURE__ */ jsx(TrendingDown, { className: "h-2.5 w-2.5" }), item.change]
											})
										]
									});
									if (isStock) return /* @__PURE__ */ jsx(Link, {
										to: "/ativo/$ticker",
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx(Building2, { className: "h-3.5 w-3.5 text-primary" }), /* @__PURE__ */ jsx("span", {
								className: "truncate",
					...
					children: [
						/* @__PURE__ */ jsxs(Link, {
							...
							children: [/* @__PURE__ */ jsxs("div", {
								...
								}), /* @__PURE__ */ jsx("div", { className: "absolute -bottom-1 -right-1 h-3.5 w-3.5 rounded-full border-2 border-[#0B0E14] bg-emerald-500" })]
							}), /* @__PURE__ */ jsxs("div", {
								className: "min-w-0",
								children: [/* @__PURE__ */ jsxs("div", {
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsxs("span", {
									...
									children: [/* @__PURE__ */ jsx(ShieldCheck, { className: "h-3.5 w-3.5 text-primary" }), "Auditoria de Aportes"]
								}), /* @__PURE__ */ jsx("span", {
						...
						/* @__PURE__ */ jsxs("nav", {
							...
							children: [
								...
								social.map((i) => /* @__PURE__ */ jsx(NavLink, {
									...i,
								...
								market.map((i) => /* @__PURE__ */ jsx(NavLink, {
									...i,
									active: isActive(i.to)
								}, i.to))
							]
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx(UploadProofDialog, { onSuccess: carregarPerfil }), /* @__PURE__ */ jsxs(Dialog, {
								open: profileOpen,
								...
								children: [/* @__PURE__ */ jsx(DialogTrigger, {
									...
									children: /* @__PURE__ */ jsxs("button", {
										...
										children: [
											/* @__PURE__ */ jsxs("div", {
												...
												}), /* @__PURE__ */ jsx("span", { className: "absolute -bottom-0.5 -right-0.5 h-3 w-3 rounded-full border-2 border-surface bg-primary" })]
											}),
											/* @__PURE__ */ jsxs("div", {
											...
											/* @__PURE__ */ jsx(ChevronRight, { className: "h-4 w-4 text-muted-foreground transition-transform group-hover:translate-x-0.5 group-hover:text-primary" })
										]
									})
								}), /* @__PURE__ */ jsxs(DialogContent, {
									...
									children: [/* @__PURE__ */ jsxs(DialogHeader, { children: [/* @__PURE__ */ jsxs(DialogTitle, {
										...
										children: [/* @__PURE__ */ jsx(User, { className: "h-5 w-5 text-primary" }), "Perfil do Investidor"]
											...
											/* @__PURE__ */ jsxs("div", {
												...
												children: [
													/* @__PURE__ */ jsxs(Button, {
														...
														children: [/* @__PURE__ */ jsx(LogOut, { className: "h-4 w-4" }), "Sair"]
													}),
													/* @__PURE__ */ jsx(Button, {
														variant: "ghost",
														className: "flex-1",
							...
							children: [/* @__PURE__ */ jsxs(Link, {
								...
								children: [
									/* @__PURE__ */ jsxs("span", {
										...
										children: [/* @__PURE__ */ jsx(Activity, { className: "h-3 w-3 text-emerald-400" }), /* @__PURE__ */ jsx("span", { children: "Sessão B3 Regular" })]
									}),
									/* @__PURE__ */ jsx("span", {
							...
							children: [
								/* @__PURE__ */ jsx(Link, {
									...
									children: /* @__PURE__ */ jsxs(Button, {
										...
										children: [/* @__PURE__ */ jsx(Sparkles, { className: "h-3.5 w-3.5" }), /* @__PURE__ */ jsx("span", { children: "Simulador Markowitz" })]
									})
								}),
								/* @__PURE__ */ jsx("button", {
			...
			/* @__PURE__ */ jsx("nav", {
				...
				children: mobileNav.map(({ to, label, icon: Icon }) => /* @__PURE__ */ jsxs(Link, {
					to,
					...
					children: [/* @__PURE__ */ jsx(Icon, { className: "h-5 w-5" }), /* @__PURE__ */ jsx("span", {
						className: "truncate",
						children: label
					})]
				}, to))
...
function RootComponent() {
	...
	return /* @__PURE__ */ jsxs(QueryClientProvider, {
		client: queryClient,
		children: [path === "/login" ? /* @__PURE__ */ jsx(Outlet, {}) : /* @__PURE__ */ jsx(AppShell, { children: /* @__PURE__ */ jsx(Outlet, {}) }), /* @__PURE__ */ jsx(Toaster$1, { position: "top-center" })]
	});
}
//#endregion
//#region src/routes/index.tsx
var $$splitComponentImporter$10 = () => import("./routes-Bi2gnVq1.js");
...
//#endregion
//#region src/routes/carteira.tsx
var $$splitComponentImporter$9 = () => import("./carteira-BVEgXuOe.js");
...
var $$splitComponentImporter$8 = () => import("./chat-fK2FuR9B.js");
...
//#endregion
//#region src/routes/grupos.tsx
var $$splitComponentImporter$7 = () => import("./grupos--rcH7GjO.js");
...
var $$splitComponentImporter$6 = () => import("./login-BvJogz2N.js");
...
//#endregion
//#region src/routes/mercado.tsx
var $$splitComponentImporter$5 = () => import("./mercado-C_Q9Q_sb.js");
...
var $$splitComponentImporter$4 = () => import("./noticias-DZbOFnS3.js");
...
//#endregion
//#region src/routes/questionario.tsx
var $$splitComponentImporter$3 = () => import("./questionario-UkssTW1B.js");
...
//#endregion
//#region src/routes/ranking.tsx
var $$splitComponentImporter$2 = () => import("./ranking-CtT8fdK3.js");
...
//#endregion
//#region src/routes/smart-invest.tsx
var $$splitComponentImporter$1 = () => import("./smart-invest-CgOwPQTA.js");
...
//#endregion
//#region src/routes/ativo.$ticker.tsx
var $$splitComponentImporter = () => import("./ativo._ticker-B-x8ym4W.js");
...
//#endregion
export { badges as a, groups as c, portfolios as d, priceSeries as f, getRouter, assets as i, messages as l, Route as n, chats as o, ranking as p, UploadProofDialog as r, currentUser as s, router_exports as t, news as u };
