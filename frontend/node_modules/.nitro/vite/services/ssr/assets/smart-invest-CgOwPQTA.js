...
import { t as api } from "./api-QcSriJ06.js";
import { d as portfolios } from "./router-B3F8OG1u.js";
import { t as Badge } from "./badge-D1Dupn2y.js";
import { useEffect, useState } from "react";
import { jsx, jsxs } from "react/jsx-runtime";
import { CheckCircle2, Loader2, Rocket, RotateCcw, Scale, ShieldCheck, Sparkles } from "lucide-react";
import { toast } from "sonner";
import { Cell, Pie, PieChart as PieChart$1, ResponsiveContainer, Tooltip } from "recharts";
//#region src/routes/smart-invest.tsx?tsr-split=component
var questions = [
	{
...
function SmartInvestPage() {
	...
	const [apiAlocacao, setApiAlocacao] = useState(null);
		...
		children: [/* @__PURE__ */ jsx("div", {
			...
			children: /* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", { children: [
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx(Sparkles, { className: "h-3.5 w-3.5" }), /* @__PURE__ */ jsx("span", { children: "Otimizador Quantitativo Markowitz & CAPM" })]
					}),
					/* @__PURE__ */ jsx("h1", {
			...
			children: [
				...
				/* @__PURE__ */ jsx("div", {
					...
					children: questions[step].options.map((o, idx) => /* @__PURE__ */ jsxs("button", {
						onClick: () => {
						...
						children: [/* @__PURE__ */ jsx("span", { children: o.label }), /* @__PURE__ */ jsxs("span", {
				...
				children: [
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx("span", {
							...
							children: /* @__PURE__ */ jsx(Meta.icon, { className: "h-6 w-6" })
						}), /* @__PURE__ */ jsxs("div", {
							className: "min-w-0",
					...
					loadingOpt ? /* @__PURE__ */ jsxs("div", {
						className: "my-8 flex items-center justify-center gap-2 text-xs text-muted-foreground",
						children: [/* @__PURE__ */ jsx(Loader2, { className: "h-4 w-4 animate-spin text-primary" }), /* @__PURE__ */ jsx("span", { children: "Otimizando fronteira de Markowitz no backend..." })]
					}) : /* @__PURE__ */ jsxs("div", {
						className: "mt-6 space-y-3",
						children: [/* @__PURE__ */ jsx("p", {
							...
							className: "space-y-2",
							children: data.map((d, i) => /* @__PURE__ */ jsxs("li", {
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs(Button, {
							...
							children: [saving ? /* @__PURE__ */ jsx(Loader2, { className: "h-4 w-4 animate-spin" }) : /* @__PURE__ */ jsx(CheckCircle2, { className: "h-4 w-4" }), /* @__PURE__ */ jsx("span", { children: "Gravar Carteira no Perfil" })]
							...
							children: [/* @__PURE__ */ jsx(RotateCcw, { className: "h-4 w-4" }), "Refazer Teste"]
						})]
					})
				]
			}), /* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsxs("div", {
					...
					children: /* @__PURE__ */ jsx(ResponsiveContainer, {
						...
						children: /* @__PURE__ */ jsxs(PieChart$1, { children: [/* @__PURE__ */ jsx(Pie, {
							...
							paddingAngle: 4,
							stroke: "none",
							children: data.map((_, i) => /* @__PURE__ */ jsx(Cell, { fill: chartColors[i % chartColors.length] }, i))
					...
					children: /* @__PURE__ */ jsxs("p", {
						...
						children: [
							...
							/* @__PURE__ */ jsx("strong", { children: "Vanguard" }),
							" e ",
							/* @__PURE__ */ jsx("strong", { children: "BlackRock" }),
							"."
						]
					})
				})]
